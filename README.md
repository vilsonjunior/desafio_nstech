![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/vilsonjunior/desafio_nstech/workflow/npm-publish-github-packages.yml?branch=main)
